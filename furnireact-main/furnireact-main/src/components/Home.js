        ...
        <Container fluid className='p-auto p-md-5'>
          <Row>
            ...
            <Col lg className='d-flex flex-column justify-content-center'>
              ...
              <p className='text-black-50'>Donec facilisis quam ut purus rutrum lobortis. Donec vitae odio quis nisl dapibus malesuada. Nullam ac aliquet velit. Aliquam vulputate velit imperdiet dolor tempor tristique. Pellentesque habitant morbi tristique senectus et netus et malesuada</p>
          ...
          <Row>
            ...
            <Col md className='py-5'>
              <Row>
                ...
                <Col xs={8}>
                  <h6 className='fw-bold'>Kruzo Aero Chair</h6>
                  <p>Donec facilisis quam ut purus rutrum lobortis. Donec vitae odio</p>
                  <a href='/'>Read More</a>
                </Col>
              </Row>
            ...
            <Col md className='py-5'>
              <Row>
                ...
                <Col xs={8}>
                  <h6 className='fw-bold'>Ergonomic Chair</h6>
                  <p>Donec facilisis quam ut purus rutrum lobortis. Donec vitae odio</p>
                  <a href='/' >Read More</a>
                </Col>
              </Row>
          ...
          <Row>
            <Col sm className='p-5 p-sm-2'>
              ...
              <Container className='p-3'>
                ...
                <p className='text-dark'>by Kristin Watson on Dec 19, 2021</p>
              </Container>
            </Col>
            <Col sm className='p-5 p-sm-2'>
              <a href='/'>
              ...
              <Container className='p-3'>
                ...
                <p className="text-dark">by Robert Fox on Dec 15, 2021</p>
              </Container>
            </Col>
            <Col sm className='p-5 p-sm-2'>
              <a href='/'>
              ...
              <Container className='p-3'>
                ...
                <p className='text-dark'>by Kristin Watson on Dec 12, 2021</p>
              </Container>
            </Col>
          </Row>
        </Container>
