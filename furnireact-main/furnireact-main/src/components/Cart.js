...
import { Navbar, Container, Nav, Row, Col, Button, Image, Stack, Carousel, Form, Table, InputGroup } from 'react-bootstrap'
          ...
          <Row>
            ...
            <Col md={4} className='p-5'>
              ...
              <Row className='pt-4'>
                ...
                <Col><p className='fw-bold text-black'>$275.00</p></Col>
              </Row>
              <Row>
                <Col><p className='text-black'>Total</p></Col>
                <Col><p className='fw-bold text-black'>$279.00</p></Col>
              </Row>
              <Row>
